document.addEventListener("DOMContentLoaded", async () => {
  ...
  const timeElapse = (date) => {
    ...
    const result = `Day <span class="digit">${days}</span> Hour <span class="digit">${hours}</span> Minute <span class="digit">${minutes}</span> Second <span class="digit">${seconds}</span>`;
